 ...
 * 
 */
public final class BruteForceNQueensSolverReducedRecursion extends GenericNQueensSolver {
	...
	public BruteForceNQueensSolverReducedRecursion(final int chessboardSizeArg, final boolean printSolutionArg) {
