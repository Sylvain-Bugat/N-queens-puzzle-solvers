 ...
 * 
 */
public final class GreedyNQueensSolverCheckCounting extends GenericNQueensSolver {
	...
	public GreedyNQueensSolverCheckCounting(final int chessboardSizeArg, final boolean printSolutionArg) {
	...
	public static void main(final String args[]) throws InvalidSolutionsException {
		...
		final GreedyNQueensSolverCheckCounting genericNQueensSolver = new GreedyNQueensSolverCheckCounting(chessboardSize, true);
