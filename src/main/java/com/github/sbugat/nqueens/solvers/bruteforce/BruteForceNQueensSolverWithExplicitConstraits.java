 ...
 * 
 */
public final class BruteForceNQueensSolverWithExplicitConstraits extends GenericNQueensSolver {
	...
	public BruteForceNQueensSolverWithExplicitConstraits(final int chessboardSizeArg, final boolean printSolutionArg) {
	...
	public static void main(final String args[]) throws InvalidSolutionsException {
		...
		final BruteForceNQueensSolverWithExplicitConstraits genericNQueensSolver = new BruteForceNQueensSolverWithExplicitConstraits(chessboardSize, true);
