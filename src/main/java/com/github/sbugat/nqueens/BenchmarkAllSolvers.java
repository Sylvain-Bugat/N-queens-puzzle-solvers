...
import com.github.sbugat.nqueens.solvers.experimental.BackTrackingNQueensSolver;
...
public abstract class BenchmarkAllSolvers {
	...
	private static List<GenericNQueensSolver> getSolvers(final int chessboardSize) {
		...
		genericNQueensSolverList.add(new BackTrackingNQueensSolver(chessboardSize, false));
