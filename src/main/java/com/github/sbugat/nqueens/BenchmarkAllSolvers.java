...
import com.github.sbugat.nqueens.solvers.backtracking.BackTrackingNQueensSolverBoolean;
...
public abstract class BenchmarkAllSolvers {
	...
	private static List<GenericNQueensSolver> getSolvers(final int chessboardSize) {
		...
		genericNQueensSolverList.add(new BackTrackingNQueensSolverBoolean(chessboardSize, false));
