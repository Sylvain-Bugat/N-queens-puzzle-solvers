...
import com.github.sbugat.nqueens.solvers.experimental.BackTrackingNQueensSolverDivide;
...
public abstract class BenchmarkAllSolvers {
	...
	private static List<GenericNQueensSolver> getSolvers(final int chessboardSize) {
		...
		genericNQueensSolverList.add(new BackTrackingNQueensSolverDivide(chessboardSize, true));
